...
export default class FormPayment extends React.Component {
  ...
  checkValidity = (type, val) => {
    ...
    switch (type) {
      case 'chargeAmount':
        validity = validateChargeAmount(val);
        error = checkErrorsChargeAmount(val);
        break;
      case 'cardCvv':
        ...
        <form noValidate className="form-payment">
          <section className={`fields-cc ${this.buildSectionStatus('cc')}`}>
            ...
            <PaymentCard
              ...
              translate={translate}
            />
            <figure className="field-charge-amount">
              ...
              <input
                ...
                className={`font-mono ${this.buildFieldStatus('chargeAmount')}`}
                required
              />
            </figure>
