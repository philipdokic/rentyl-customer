...
module CxApiService
  module Search
    ...
    class CxProperties < Main
      ...
      # Eample amenities structure:
      # amenities = {
      #   Property: [
      #     { 'property': 'ATTRACTIONS_RESTAURANTS', 'label': 'Arboretum', 'model': 'Property', 'column': 'features_attractions' },
      #     { 'property': 'LEISURE_ANTIQUING', 'label': 'Antiquing', 'model': 'Property', 'column': 'features_leisure' }
      #   ],
      #   Unit: [
      #     { 'property': 'SUITABILITY_ACCESSIBILITY_WHEELCHAIR_ACCESSIBLE', 'label': 'Wheelchair accessible', 'model': 'Unit', 'column': 'features_suitability' },
      #     { 'property': 'AMENITIES_AIR_CONDITIONING', 'label': 'Air conditioning', 'model': 'Unit', 'column': 'features_amenities' }
      #   ]
      # }
